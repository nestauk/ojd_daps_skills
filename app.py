...
with col1:
    st.image(str(PROJECT_DIR / 'docs/source/_static/nesta_escoe_transparent.png'))
...
1. The [European Commission's Skills Taxonomy](https://www.cedefop.europa.eu/en/news/esco-taxonomy-classification-european-skills-competences-qualifications-and-occupations-just#:~:text=ESCO%20is%20the%20multilingual%20classification,training%2C%20in%2025%20European%20languages.), a multilingual classification of European Skills, Competences, Qualifications and Occupations;
...
app_mode = st.selectbox("Choose a taxonomy to map onto 🗺️", [esco_tax, lightcast_tax, test_tax])
...
if button:
    ...
    if 'SKILL' in extracted_skills[0].keys():
        ...
        if len(extracted_skills[0]['SKILL']) == 1:
            ...
            st.markdown(f"**{len(extracted_skills[0]['SKILL'])}** skills were extracted.")
